...
const BlogHero = () => {
  ...
  return (
    <div className="max-h-full">
      <div className="h-[100vh] max-w-full flex flex-col items-center justify-center blog px-1">
        <h1 className="text-[1.25rem] text-center font-semibold text-[--darkorange] leading-[150%]">
          BLOGS
        </h1>
        <p className="text-[2rem] sm:text-[3rem] text-[--white] font-bold text-center">
          SUBSCRIBE TO OUR NEWSLETTER ! 🚀
        </p>
        <p className="text-[1.25rem] text-[--white] font-normal  text-center leading-[217%] max-w-[61rem] ">
